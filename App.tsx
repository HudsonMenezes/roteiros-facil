...
export default function App() {
  ...
  async function handleGenerate() {
    ...
    const prompt = `Crie um roteiro para uma viagem de exatos ${days.toFixed(
      0
    )} dias na cidade de ${city}, busque por lugares turisticos, lugares mais visitados, seja preciso nos dias de estadia fornecidos e limite o roteiro apenas na cidade fornecida. Forneça apenas em tópicos com nome do local onde ir em cada dia e o que fazer por lá separando as sugestões por manhã, tarde e noite.`;

    fetch("https://api.openai.com/v1/chat/completions", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${process.env.CHATGPT_APIKEY}`,
    ...
    <View style={styles.container}>
      ...
      <View>
        <Text style={styles.rodape}>
          Roteiros Fácil v1.0 <Text style={{ color: "#FF5656" }}> </Text>
        </Text>
      </View>
    </View>
  );
